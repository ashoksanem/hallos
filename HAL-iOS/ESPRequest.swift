...
class ESPRequest: NSObject, URLSessionDelegate,URLSessionDataDelegate,URLSessionTaskDelegate, XMLParserDelegate {
    ...
    func getZipCode() {
        ...
        let soapmessageheader = "<soap:Envelope xmlns:soap='http://schemas.xmlsoap.org/soap/envelope/'><soap:Header><ns2:requestor_info xmlns:ns4='http://sei.v" + espVersion + ".services.esp.macys.com/' xmlns:ns3='http://messages.services.esp.macys.com' xmlns:ns2='http://www.macys.com/enterprise_services'><version>01.000.0000</version>      <client_id>Stores</client_id><subclient_id>SPOS</subclient_id></ns2:requestor_info></soap:Header><soap:Body><ns4:getRequestedParameters xmlns:ns2='http://www.macys.com/enterprise_services' xmlns:ns3='http://messages.services.esp.macys.com' xmlns:ns4='http://sei.v" + espVersion + ".services.esp.macys.com/'>";
