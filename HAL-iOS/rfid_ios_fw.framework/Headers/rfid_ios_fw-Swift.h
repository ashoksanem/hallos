...
#import <rfid_ios_fw/rfid_ios_fw.h>
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="rfid_ios_fw",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC11rfid_ios_fw12DeviceStatus")
@interface DeviceStatus : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11rfid_ios_fw17FindProductWorker")
@interface FindProductWorker : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC11rfid_ios_fw15InventoryWorker")
@interface InventoryWorker : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC11rfid_ios_fw7RfidSDK")
@interface RfidSDK : NSObject <TVMobileSDKDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)tvLocateDidTag:(NSString * _Null_unspecified)upc changeProximity:(NSUInteger)proximityPercentage;
...
/// returns:
/// TAG_LOCATING_RESULT
- (void)tvReaderDidScanBarcode:(NSString * _Null_unspecified)barcode;
...
- (void)tvInventoryDidOpenSession:(TVInventoryResult)result inZone:(NSString * _Null_unspecified)zoneId withSessionId:(NSString * _Null_unspecified)sessionId withIsSessionOwner:(BOOL)isSessionOwner;
- (void)tvInventoryDidReadTag:(NSString * _Null_unspecified)epc;
- (void)tvUserDidAuthenticate:(TVCommResult)result token:(NSString * _Null_unspecified)token;
@end

@class TagInfo;

SWIFT_PROTOCOL("_TtP11rfid_ios_fw15RfidSDKDelegate_")
@protocol RfidSDKDelegate <NSObject>
@optional
...
- (void)EventInventoryDidReadTag:(NSString * _Nonnull)epc;
- (void)EventUserDidAuthenticate:(BOOL)isSuccess;
@end


SWIFT_CLASS("_TtC11rfid_ios_fw7TagInfo")
...
SWIFT_PROTOCOL("_TtP11rfid_ios_fw16WriteTagDelegate_")
@protocol WriteTagDelegate <NSObject>
@optional
- (void)EventWriteTagDidWriteWithData:(NSDictionary<NSString *, id> * _Nonnull)data;
@end


SWIFT_CLASS("_TtC11rfid_ios_fw14WriteTagWorker")
@interface WriteTagWorker : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC11rfid_ios_fw19XMLRequestEPCParser")
@interface XMLRequestEPCParser : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
@interface XMLRequestEPCParser (SWIFT_EXTENSION(rfid_ios_fw)) <NSXMLParserDelegate>
